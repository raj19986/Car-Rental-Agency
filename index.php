...
if(isset($_POST['submit'])) {
    ...
    if($_SESSION['USER_ID']){  // check panel Login
        ...
        $booking_days  = mysqli_real_escape_string($conn, $_POST['booking_days']);
            ...
            $sql = "insert into  tbl_booked_vehicles( `vehicle_id`, `user_id`,`date`,`booking_days`,`admin_id`)  values ('$vehicle_id','$user_id','$date',$booking_days,'$admin_id')";
...
<body>
    ...
    <section class="after-header">
        ...
        <div class="buttons">
            <a href="admin/login.php" class="user-btn" style="font-size:18px;">Agency Login</a>
            <a href="admin/register.php" class="user-btn" style="font-size:18px;">Agency Register</a>
            <?php 
            if(!$_SESSION['USER_ID']){ ?>
            <a href="register.php" class="admin-btn"> User Register</a>
            <?php }?>
            <?php 
            if(!$_SESSION['USER_ID']){  ?>

            <a href="login.php" class="user-btn" style="font-size:18px;" User > Login</a>
        ...
        <div class="child">
            ...
            <form action="index.php" method="post">
                <?php if($_SESSION['USER_ID']){ ?>
                    ...
                    <input type="hidden" name="admin_id" value="<?php echo $row['admin_id']; ?>"><br>
