...
if(isset($_POST['submit'])) {
    ...
    if( $error == FALSE){
        ...
        if( $query){
            ...
            $msg = '<div class="alert alert-success"> Agency Registered Succsessfully</div>';
...
<html lang="en">
    <head>
        ...
        <title>Agency Registation</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Register Agency Account</h3></div>
                                    <div class="card-body">
                                                <p style="color:red">
                                          <?php 
